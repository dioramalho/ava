<?php include 'shared/header-professor.php'; ?>
  <body class="ete-app-shell">
    ...
    <main class="container-xxl py-4 py-md-5">
      <section class="ete-page-hero mb-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
        <div>
          <h1 class="h3 fw-bold mb-2">Aulas</h1>
          <p class="mb-0" style="opacity: 0.9">Cada aula nasce ligada a uma turma e a uma disciplina. Ao salvar, já fica visível para o aluno.</p>
        </div>
        <a href="professor-aula.php" class="btn btn-ete-yellow btn-touch">Nova aula</a>
      </section>
    ...
    <script src="js/professor-aulas.js?v=4"></script>
  </body>
</html>
